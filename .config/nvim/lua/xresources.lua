...
function xresources.load_syntax()
   local syntax = {
      ...
      BufferCurrent = { fg=xresources.yellow, bg=xresources.none, style ='bold'};
      BufferCurrentSign = { fg=xresources.blue, bg=xresources.none };
      BufferTabPageFill = { fg=xresources.blue, bg=xresources.none };
      BufferCurrentMod = { fg=xresources.blue, bg=xresources.none };
      ...
      FoldColumn = {fg=xresources.fg,bg=xresources.none};
